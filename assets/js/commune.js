...
var urldemandeCertificat = geoserverURL+ "/geoserver/landplateform/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=%20certificats&CQL_FILTER=updated_or_new+=+%27true%27&outputFormat=application/json"; 
...
var certificatArectifierurl = geoserverURL + "/geoserver/landplateform/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=%20certificats&CQL_FILTER=a_rectifier+=+%27true%27&outputFormat=application/json"; 
...
var url = geoserverURL + "/geoserver/landplateform/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=%20certificats&CQL_FILTER=validee_publiee+=+%27false%27&outputFormat=application/json"; 
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            $.each(response.slice(0, 5), function (index, data){
                ...
                a.on('click', function() { 
                  centerMapTo(lat, lon);
                  ShowFormRect(data.gid, data.couche, data.observation, data.numcf, data.numdemande, data.surface)
                }); 
