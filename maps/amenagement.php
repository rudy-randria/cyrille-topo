...
<head>
  ...
  <title>Cartographie - Aménagement</title>
  ...
  <div class="wrapper">
    ...
    <nav class="navbar navbar-expand-sm navbar-dark bg-dark" style="margin: 0;">
      <div class="container-fluid">
        <a class="navbar-brand" href="javascript:void(0)">AMENAGEMENT</a>
      ...
      <section>
        <!-- formlaire de demande -->
          <div id="formDivDemande">
            ...
            <form class="form-group" id="formDemande" method="POST" action="../controllers/amenagementController.php">
              ...
              <div class="form-group">
                <label for="numcf" id="numerolabel"> Code : </label>
          ...
          <div id="formDivRect">
            ...
            <form class="form-group" id="formrectification" method="POST" action="../controllers/amenagementController.php">
              <div class="form-group">
          ...
          <div id="formDivRefus">
            ...
            <form class="form-group" id="formrefus" method="POST" action="../controllers/amenagementController.php">
              <div class="form-group">
                <label for="numcf" id="numerolabel"> Remarque du comité : </label>
...
<script type="module" src="../assets/js/amenagement.js"></script>
